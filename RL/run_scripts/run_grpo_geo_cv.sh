...
# on remote
data_paths="path/to/jsonl" 
image_folders="path/to/cv_cities_16k"
model_path="path/to/base_model or Huggingface Model"
is_reward_customized_from_vlm_module=False
reward_methods="mcq"  
echo "data_paths: $data_paths"
echo "image_folders: $image_folders"

export EXP_NAME="Geo-R1-Test" # TODO: change this to your own experiment name
TASK_TYPE="default"
...
torchrun --nproc_per_node="8" \
  ...
  src/open_r1/grpo_jsonl.py \
    --use_vllm False \
    --output_dir /data/Geo-R1/checkpoints/rl/${EXP_NAME} \
